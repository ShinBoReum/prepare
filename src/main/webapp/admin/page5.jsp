...
<head>
	...
	function loginform(){
		var jumin1 = $("input[name='JUMIN_NO1']").val();
		var jumin2 = $("input[name='JUMIN_NO2']").val();
		var jumin = jumin1 + "-" + jumin2;
		var BIRTH_YMD = $("input[name='BIRTH_YMD1']").val() + "/" + $("input[name='BIRTH_YMD2']").val() + "/" + $("input[name='BIRTH_YMD3']").val()
		
		$("input[name='JUMIN_NO']").val(jumin);
		$("input[name='BIRTH_YMD']").val(BIRTH_YMD);
		
		console.log(BIRTH_YMD);
		
		$("form").attr("method" , "POST").attr("action" , "/user/insert").submit();
	}
	...
	<input type="hidden" name="user_no" value="${user.user_no }">
		<div class="page_in float_h">
			...
			<div class="page_mar2 float_l">
				...
				<div class="page_mar1">
					...
					<input name="JUMIN_NO1" type="text" size="6" maxlength="6" > - <input name="JUMIN_NO2" type="text" size="7" maxlength="7">
				</div>
			</div>
		</div>
		<div class="page_in clear_b">
			...
			<div class="page_line page_mar1">
				...
				<input type="hidden" name="BIRTH_YMD" value="">
				<input name="BIRTH_YMD1" type="text" size="8"> 년 <input name="BIRTH_YMD2" type="text" size="5" > 월 <input name="BIRTH_YMD3" type="text" size="5" > 일 ( <input type="radio" name="radiobutton" value="radiobutton"> 양력 <input type="radio" name="radiobutton" value="radiobutton"> 음력 )
			</div>
			<div class="page_line page_mar1">
