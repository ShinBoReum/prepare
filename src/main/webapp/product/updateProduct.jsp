...
<%@ page import="com.boreum.service.domain.*" %>
				...
				<tr>
					<td width="105">
						<%-- <input 	type="text" name="brand" class="ct_input_g" 
										style="width: 100px; height: 19px" maxLength="20" value="${product.brand}"> --%>
						<select name="brand_id" class="ct_input_g" 
									style="width: 100px; height: 25px" maxLength="20">
						<option>브랜드</option>
						<option  ${ product.brandName.brandNam=='벤츠' ? "selected" : "" } value="115">벤츠</option>
						<option  ${ product.brandName.brandNam=='포르쉐' ? "selected" : "" } value="116">포르쉐</option>
						<option  ${ product.brandName.brandNam=='볼보' ? "selected" : "" } value="117">볼보</option>
						<option  ${ product.brandName.brandNam=='마세라티' ? "selected" : "" } value="118">마세라티</option>
						<option  ${ product.brandName.brandNam=='기아' ? "selected" : "" } value="111">기아</option>
						<option  ${ product.brandName.brandNam=='미니쿠퍼' ? "selected" : "" } value="119">미니쿠퍼</option>
					</select>
					</td>
				</tr>
			</table>
